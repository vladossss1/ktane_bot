...
public class WhosOnFirstModule extends BombModule {

    public static final Map<String, Integer> stepOne = Map.ofEntries(
    ...
    public static final Map<String, List<String>> stepTwo = Map.ofEntries(
